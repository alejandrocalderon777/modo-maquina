...
export const EXERCISES: Exercise[] = [
  ...
  { id:'gl2', name:'Sentadilla búlgara', muscle:'Glúteos', sets:'3×12 c/pierna', equipment:'mancuernas', level:'intermedio', tip:'Pie trasero elevado, baja recto.', dbId:'Bulgarian_Split_Squat' },
  ...
  // ── CARDIO ──
  { id:'ca1', name:'Trote continuo', muscle:'Cardio', sets:'25-30 min', equipment:'ninguno', level:'principiante', tip:'Ritmo constante, respira controlado.', dbId:'Rowing_Stationary' },
  { id:'ca2', name:'HIIT intervalos', muscle:'Cardio', sets:'15-20 min', equipment:'ninguno', level:'intermedio', tip:'30seg intenso / 30seg descanso.', dbId:'Burpee' },
  { id:'ca3', name:'Burpees', muscle:'Cardio', sets:'4×15', equipment:'ninguno', level:'avanzado', tip:'Flexión + salto explosivo.', dbId:'Burpee' },
